...
public class SchemeProvisionWorkRequestJPanel extends javax.swing.JPanel {
    ...
    public void populateTable(){
        ...
        if(request.getAddressesForHomeless()!=null){
            for(List<String> address:request.getAddressesForHomeless()){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Scheme Option1");
        ...
        jLabel8.setText("Schemes will be provided to below Person:");
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        fcRequest.setAddressesForHomeless(request.getAddressesForHomeless());
        ...
        for (Network network : business.getNetworkList()) {
            ...
            for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                if (enterprise instanceof LocalPublicAgencyEnterprise) {
                    for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
                        if (organization instanceof FinalizeHousingOrganization) {
                            org = organization;
                            break;
                        }
                    }
